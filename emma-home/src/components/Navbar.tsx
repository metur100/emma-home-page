  ...
  <div className="container"> <a className="navbar-brand navbar-logo" href="#"> <img src="/images/logo.png" alt="logo" className="logo-1" /> </a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="1">O aplikaciji</a> </li>
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="2">Znacajke</a> </li>
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="3">Tim</a> </li>
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="4">Testimonials</a> </li>
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="5">Najcesca pitanja</a> </li>
        <li className="nav-item"> <a className="nav-link" href="#" data-scroll-nav="6">Kontak informacije</a> </li>
      </ul>
    </div>
  </div>
</nav>
