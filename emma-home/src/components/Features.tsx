    ...
    <div className="row">
      <div className="col-md-12">
        <div className="sectioner-header text-center">
          ...
          <p>Ovo su neke od ključnih karakteristika koje izdvajaju našu platformu:</p>
        </div>
            ...
            <div className="col-md-4 col-sm-12">
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                <div className="media-body text-right media-right-margin">
                  ...
                  <p>Brzo kreirajte i upravljajte ponudama za teret s detaljnim informacijama kako biste privukli odgovarajuće transportne partnere.</p>
                </div>
              ...
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.4s">
                <div className="media-body text-right media-right-margin">
                  ...
                  <p>Pregledajte i upravljajte vašom flotom vozila, olakšavajući pronalaženje odgovarajućih poslova u zavisnosti od kapaciteta i dostupnosti.</p>
                </div>
              ...
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.6s">
                <div className="media-body text-right media-right-margin">
                  ...
                  <p>Sigurno učitajte, sačuvajte i razmjenjujte važne dokumente povezane s vašim teretom i ugovorima o transportu, pojednostavljujući papirologiju.</p>
                </div>
            ...
            <div className="col-md-4 col-sm-12">
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div className="media-body text-left">
                  ...
                  <p>Iskoristite našu integrisanu funkciju planiranja ruta kako biste optimizirali svoje transportne rute, štedeći vrijeme i gorivo.</p>
                </div>
              </div>
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.4s">
                ...
                <div className="media-body text-left">
                  ...
                  <p>Pristupite ključnim alatima i opcijama kroz naš intuitivni raspored nadzorne ploče, poboljšavajući produktivnost i efikasnost.</p>
                </div>
              </div>
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.6s">
                ...
                <div className="media-body text-left">
                  ...
                  <p>Prilagodite svoje ponude za teret i transport prema specifičnim potrebama, omogućujući vam efikasno pregovaranje i zaključivanje poslova.</p>
                </div>
              </div>
            </div>
          </div>
